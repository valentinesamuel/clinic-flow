...
export const mockPatients: Patient[] = [
  ...
  // Test HMO Patients for claim testing
  {
    id: 'pat-011',
    mrn: 'LC-2024-0011',
    firstName: 'Nkechi',
    ...
    email: 'nkechi.onyekachi@email.com',
  ...
  },
  {
    ...
    email: 'amara.okwu@email.com',
    address: '42 Wuse 2, Zone 5',
    state: 'Abuja',
    lga: 'Municipal',
    nationality: 'Nigerian',
    occupation: 'Business Owner',
    ...
    hmoDetails: {
      providerId: 'axa-001',
      providerName: 'AXA Mansard Health',
      enrollmentId: 'AXA-2024-AOK003',
      planType: 'Premium',
    ...
    nextOfKin: {
      ...
      address: '42 Wuse 2, Zone 5, Abuja',
    },
